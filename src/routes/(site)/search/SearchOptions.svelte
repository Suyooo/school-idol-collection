    ...
    <div class="col-half mt-4 lg:mt-0 lg:pl-4 grid grid-cols-[1fr,3fr] gap-2 items-center">
        {#if options.cardType === "member"}
            ...
            <div class="flex gap-1">
                ...
                <select
                    class="flex-grow"
                    bind:value={options.memberCostMod}
                    disabled={!uiOptionIsSet(options.memberCost)}
                >
            ...
            <div class="flex gap-1">
                ...
                <select
                    class="flex-grow"
                    bind:value={options.memberPiecesMod}
                    disabled={!uiOptionIsSet(options.memberPieces)}
                >
                    <option value="" selected>exactly</option>
                    <option value="-">or less</option>
                    <option value="+">or more</option>
        ...
        {:else if options.cardType === "song"}
            ...
            {:else}
                <div class="self-start mt-2.5 col-span-full">
