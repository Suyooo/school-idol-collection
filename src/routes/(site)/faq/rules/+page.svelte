	...
	<div class="panel">
		<div class="panel-inner">
			...
			<p>
				...
				Bonuses out completely. These are of course not the only possibilities, feel free to get creative - for example,
			...
			<p>
				...
				It is recommended to use one unified sleeve for the cards in the Deck and another unified sleeve for the cards in
				the Set List. This will make the game easier to play.<br />
				<br />
				...
				Cards you bring into play from your Collection do not need sleeving, unless they could be turned face-down at any
				point. In that case, sleeving is required. If you plan to bring Member or Song cards from your Collection into play,
				make sure they have the same sleeving as your other cards of the same type.
			</p>
		</div>
	</div>
	<div class="panel">
		<div class="panel-inner">
			...
			<div>
				...
				Certain cards can be linked into Pairs or Trios. Their illustrations will combine into one larger image if you do
				so.<br />
				<br />
				...
				<br />
				As a Pair or Trio, the cards will join <b>⟪LIVE⟫</b>s together and activate additional Pair/Trio Skills. For
			...
			<div>
				...
				<br />
				Memories are comparable to field effects in other TCGs, usually activating passive Skills affecting the cards on
				your Stage and <b>⟪LIVE⟫</b>s you perform. You can only bring them into play by using the Skills of Member or
				Song cards refering to that specific Memory. You can check the "See Also" links on the page of a Memory card to
			...
			<div>
				...
				<br />
				Cards that have a <TriggerComponent trigger={TriggerEnum.SP} /> Skill are Idolizable. You can Idolize these cards
				by stacking them on top of another card already on your Stage, which must meet the requirements mentioned by the
				...
				below the regular ones, right above the Member's birthday), or use more powerful Skills. You can learn more from
				the
