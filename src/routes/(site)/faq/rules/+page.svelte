...
<div class="content">
    ...
    <div class="panel">
        <div class="panel-inner">
            ...
            <div>
                ...
                already used in your Deck or Set List.<br />In tournament games, to avoid having to deal with your
                entire Collection all the time, it is treated more like an extra deck in other TCGs - which you prepare
                with all the cards you might want to use during a game, before the match.
    ...
    <div class="panel">
        <div class="panel-inner">
            ...
            <p>
                Cards from your Collection you might look for during the game must be prepared and placed on the table
                you're playing on. While it is not your actual Collection, this prepared set is what should be used as
                your "Collection" during official events.
            </p>

            <h5 id="official_banlist">Card Bans</h5>
            <div class="ml-4">
                If you have a card from Set A in your Deck, Set List or Collection, you must not have any cards from Set
                B in your Deck, Set List or Collection.
