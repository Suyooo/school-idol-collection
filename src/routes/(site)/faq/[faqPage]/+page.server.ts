			...
			qa: [
				{
					...
					answer:
						'No. If, for example, {{link:LL02-046}} is joining a ⟪LIVE⟫ with either a {{red:"Kotori"}} or {{red:"Hanayo"}} card, she will gain +[ALL].',
				},
			],
		},
		{
		...
		},
		{
			...
			qa: [
				...
				},
				{
					...
					answer:
						'Yes. That Member is on Stand-By, so you can return it to your Hand. If they are the only Member other than {{red:"Maki"}}, you have to return it.',
				},
			],
		},
		{
			...
			qa: [
				{
					...
					answer:
						'No. This Skill counts the amount of Member cards, not different Members. In this case, the {{red:"Nico"}} card is one of three total Members, so the condition is not met and the Piece is not added.',
				},
			],
		},
		{
			...
			qa: [
				{
					...
					answer:
						'Any card that is not this one. For example, you may use this Member\'s Skill to give +[ALL][ALL] to any other {{red:"Nozomi"}} card, including another {{link:LL03-061}}.',
				},
			],
		},
		{
			...
			qa: [
				{
					...
					answer:
						'No. It is not neccessary for all three to be there. For example, if you perform a ⟪LIVE⟫ with {{link:LL03-072}} with only {{red:"Honoka"}} cards, the Any Piece requirement is still reduced by 3.',
				},
			],
		},
	],
			...
			qa: [
				{
					...
					answer:
						'Yes. For example, if two of this {{red:"Riko"}} card join a ⟪LIVE⟫, you can, together with the one Song card you flip from performing a ⟪LIVE⟫ by default, flip a total of three cards.',
				},
			],
		},
		{
			...
			qa: [
				{
					...
					answer:
						"Yes. As long as you return a card to the bottom of your Deck, you can choose either.<br>If you don't have any cards in your Hand, you can't ⟪ENTER⟫ a card from your Hand, which means you can't do anything when picking that option.",
				},
			],
		},
		{
			...
			qa: [
				{
					...
					answer:
						'Even if the card is visible to them, the next player must "guess" whether it has Stars or not, then use the effect corresponding to the answer.<br>If your Deck is empty, you cannot use this Skill.',
				},
			],
		},
		{
			...
			qa: [
				{
					...
					answer:
						"Yes. For example, if you have no cards in your Hand and no Song cards that are Live on your Stage when this card is ⟪ENTER⟫ed, you may both draw three cards and perform a ⟪LIVE⟫ with this card.",
				},
			],
		},
		{
			...
			qa: [
				{
					...
					answer:
						'Yes. The [Entry] Skills are handled seperately for each card, so the first card can join a ⟪LIVE⟫. However, the second {{red:"Riko"}} will not be able to join yet in that turn.',
				},
				{
					key: "live",
					question: "I used this card's [RUSH] to ⟪ENTER⟫ another Member with [LIVE]. Can I perform a ⟪LIVE⟫?",
					answer:
						"Yes. This card cannot join the ⟪LIVE⟫ due to the Skill, but you can still perform ⟪LIVE⟫s using other Members' [LIVE].",
				},
			],
		},
		{
			...
			qa: [
				{
					...
					answer:
						'Yes. The {{red:"Mari"}} card has a [LIVE] icon, so you can use this card\'s Skill to perform a ⟪LIVE⟫.',
				},
			],
		},
		{
			...
			qa: [
				...
				},
				{
					...
					answer:
						"No. The Song name is not part of the Skill text, so the requirement for the second Skill is not met.",
				},
			],
		},
		{
		...
		},
		{
			...
			qa: [
				...
				},
				{
					...
					answer:
						"No. The Skill requires this card to have been ⟪ENTER⟫ed as the direct result of a [RUSH]. It does not depend on whether the card you used to ⟪ENTER⟫ this card has a [RUSH] icon or not.",
				},
			],
		},
		{
			...
			qa: [
				{
					...
					answer:
						"Yes. If their requirements are met, Pieces gained through [Live Join] Skills can be used for this Skill's requirement.",
				},
			],
		},
		{
			...
			qa: [
				{
					...
					answer:
						"Yes. {{link:LL04-054}} is at the bottom of the Deck at the time the [Entry] Skill is resolved, so you can ⟪ENTER⟫ it from there.",
				},
			],
		},
		{
			...
			qa: [
				{
					...
					answer:
						"Yes. The requirement is not only met if you pick ⟪ENTER⟫ as your turn action, but also if you use a [RUSH] or a Skill to ⟪ENTER⟫ this card.",
				},
			],
		},
		{
			...
			qa: [
				...
				},
				{
					...
					answer:
						'No. If the first part of the requirement is not met, you cannot use the second part of the Skill past the "Then...".',
				},
			],
		},
		{
			...
			qa: [
				{
					...
					answer:
						'You might have to skip a turn due to some Skills (such as {{link:LL01-071}} and {{link:LL04-051}}). If you were affects by such a Skill at least once in this match, you have "skipped a turn". Otherwise, if you haven\'t had a Skill like that affect you in this match so far, you "haven\'t skipped a turn".',
				},
				{
					key: "intent",
			...
			qa: [
				{
					...
					answer:
						'Yes. Their Skills will affect each other\'s [SMILE], so this results in treating all Pieces of all {{red:"Hanamaru"}} cards as [ALL].',
				},
			],
		},
		{
			...
			qa: [
				{
					...
					answer:
						"Yes. The requirement is not only met if you pick ⟪ENTER⟫ as your turn action, but also if you use a Skill to ⟪ENTER⟫ this card.",
				},
				{
					key: "sameturn",
					question:
			...
			qa: [
				{
					...
					answer:
						'Count how many cards of each differently named Member have joined this ⟪LIVE⟫.<br>For example, if there are three {{red:"Chika"}} cards, two {{red:"You"}} cards, and one {{red:"Riko"}} card joining a ⟪LIVE⟫, {{red:"Riko"}} is the Member with the lowest number of cards in this ⟪LIVE⟫.',
				},
				{
					key: "none",
					question:
			...
			qa: [
				{
					...
					answer:
						"Yes. No matter how many people are playing in the match, the requirement is met for whoever is the last to take their turn.",
				},
				{
					key: "move",
					question:
					...
					answer:
						"No. Only the order as it was decided during setup counts, so the player who is last in the turn order doesn't change.",
				},
			],
		},
		{
			...
			qa: [
				{
					...
					answer:
						'Yes. The "all your face-up Song cards have the same Attribute" requirement is met in this case, so you can flip one face-down Song card face-up.',
				},
			],
		},
		{
			...
			qa: [
				{
					...
					answer:
						"It means a Member who has the exact same number including Piece attributes as another Member. The order of Pieces does not matter, so if you ⟪ENTER⟫ed a Member with [SMILE][PURE], you can ⟪ENTER⟫ another Member with [PURE][SMILE].",
				},
				{
					key: "bday",
					question:
					...
					answer:
						"Yes. When the Birthday Bonus is active, the bonus Pieces are added to that card, so in this example, you can ⟪ENTER⟫ {{link:LL07-051}}.",
				},
			],
		},
		{
			...
			qa: [
				{
					...
					answer:
						"Yes. Since it's the only card you can look at from your Deck, you will only be to ⟪ENTER⟫ the card your returned to your Deck.",
				},
			],
		},
		{
			...
			qa: [
				{
					...
					answer:
						'The first {{red:"Hanamaru"}} \'s Skill will result in the player drawing a card. After that, when the Skills of the other {{red:"Hanamaru"}} cards are resolved, the player will have more cards in their Hand than the other player, so the cards will gain +[ALL].',
				},
			],
		},
		{
			...
			qa: [
				{
					...
					answer:
						"No. Skills such as [Live Join] will only be resolved at that time, so when the card is still in your Hand, it does not have [ALL].",
				},
				{
					key: "idolize",
					question:
					...
					answer:
						"Yes. This [Entry] Skill counts the number of Pieces after the Member was ⟪ENTER⟫ed. If a Member is Idolized through a [Special Practice] Skill, [Idolized (Piece Bonus)] will be active when the card appears on the Stage, so including those, the Member has three or more [ALL] and the requirement is met.",
				},
			],
		},
		{
			...
			qa: [
				{
					...
					answer:
						"No. When they reach the Live Points target, the winner is removed from the rest of the match, so they cannot perform a ⟪LIVE⟫.",
				},
				{
					key: "other",
					question: 'What happens if non-{{red:"CYaRon!"}} Members are participating in this ⟪LIVE⟫?',
					answer:
						'As long as {{red:"Chika"}}, {{red:"You"}} and {{red:"Ruby"}} have joined this ⟪LIVE⟫, the Skill can be used no matter what other Members are participating.',
				},
			],
		},
		{
			...
			qa: [
				{
					...
					answer:
						'No. The Skill of this Song card changes all [SMILE][PURE][COOL] of the Members joining this ⟪LIVE⟫ into [ALL] before [Live Join] Skills are resolved. That means that in this case, {{red:"Mari"}} does not gain +[ALL].',
				},
				{
					key: "later",
					question:
				...
				},
				{
					...
					answer:
						'As long as {{red:"Kanan"}}, {{red:"Dia"}} and {{red:"Hanamaru"}} have joined this ⟪LIVE⟫, the Skill can be used no matter what other Members are participating.',
				},
			],
		},
		{
			...
			qa: [
				{
					...
					answer:
						'It means that you may ⟪ENTER⟫ up to one {{red:"Riko"}}, one {{red:"Yoshiko"}}, and one {{red:"Mari"}}. That means you can for example ⟪ENTER⟫ three Members, one of each, or ⟪ENTER⟫ only a {{red:"Riko"}} and a {{red:"Yoshiko"}} card.',
				},
				{
					key: "other",
					question: 'What happens if non-{{red:"Guilty Kiss"}} Members are participating in this ⟪LIVE⟫?',
					answer:
						'As long as {{red:"Riko"}}, {{red:"Yoshiko"}} and {{red:"Mari"}} have joined this ⟪LIVE⟫, the Skill can be used no matter what other Members are participating.',
				},
			],
		},
		{
			...
			qa: [
				{
					...
					question: `What are "Base Live Points"?`,
					answer:
						"It refers to the large number in the top right of the Song card. If there are Bonus Live Points on a card, like {{link:LL03-075}}, it only refers to the number on the left. (That means that {{link:LL03-075}} does not meet the requirement.)",
				},
				{
					key: "none",
