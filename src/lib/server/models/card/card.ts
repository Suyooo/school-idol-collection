...
import type CardMemberIdolizeType from "$l/enums/cardMemberIdolizeType.js";
import type { CardOrientation } from "$l/enums/cardOrientation.js";
import CardType from "$l/enums/cardType.js";
import type { GroupID } from "$l/enums/group.js";
import type CardFAQLink from "$m/card/faqLink.js";
    ...
    validate: {
        memberTypeMustHaveMemberExtraInfo(this: Card) {
            if ((this.type === CardType.MEMBER) !== (this.member != null)) {
                ...
                else throw new Error("Card has a Member Extra Info object, but is not of Member type");
            }
            return true;
        },
        songTypeMustHaveSongExtraInfo(this: Card) {
            if ((this.type === CardType.SONG) !== (this.song != null)) {
                ...
                else throw new Error("Card has a Song Extra Info object, but is not of Song type");
            }
            return true;
        },
    },
...
export class CardBase extends Model {
    ...
    @HasMany((s) => s.models.Skill, {
        foreignKey: { name: "cardNo", onDelete: "CASCADE" },
        inverse: { as: "card" },
    })
...
export class CardMemberWithIdolizePieces extends CardMember {
    declare member: Omit<CardMemberExtraInfo, "idolizeType" | "idolizeBonus"> & {
        idolizeType: CardMemberIdolizeType.WITH_PIECES;
        idolizeBonus: CardMemberIdolizePieceExtraInfo;
    };
}
...
export class CardSongWithAnyReq extends CardSongBase {
    declare song: Omit<CardSongExtraInfo, "anyRequirement" | "attrRequirement"> & {
        anyRequirement: CardSongAnyReqExtraInfo;
        attrRequirement: null;
    };
}
...
export class CardSongWithAttrReq extends CardSongBase {
    declare song: Omit<CardSongExtraInfo, "anyRequirement" | "attrRequirement"> & {
        anyRequirement: null;
        attrRequirement: CardSongAttrReqExtraInfo;
    };
}
